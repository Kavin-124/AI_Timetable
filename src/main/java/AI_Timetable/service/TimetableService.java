...
public class TimetableService {
    ...
    public List<TimetableSlot> generateTimetable(String configName) {
        ...
        for (Teacher t : teachers) {
            if (t.getName().equals("Study Hall")) { studyHall = t; break; }
        }
        if (studyHall == null) {
            studyHall = new Teacher(); studyHall.setName("Study Hall"); studyHall.setDepartment("Library");
            studyHall = teacherRepo.save(studyHall); teachers.add(studyHall);
        }

        Set<String> busyProfessors = new HashSet<>();
        String[] days = {"Monday", "Tuesday", "Wednesday", "Thursday", "Friday"};
        String[] periods = { "09:00 AM - 10:00 AM", "10:00 AM - 11:00 AM", "11:15 AM - 12:15 PM", "12:15 PM - 01:15 PM", "02:00 PM - 03:00 PM", "03:00 PM - 04:00 PM", "04:15 PM - 05:15 PM", "05:15 PM - 06:15 PM" };
    ...
    public List<TimetableSlot> getTimetable(String configName) {
        return slotRepo.findByScheduleName(configName);
    }
